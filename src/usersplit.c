 ...
 * Here we just use the eval function
 */
void usersplit_parent_objective(int n, double *y[], double *value, double *parent_objective,
	     double *wt) {
	usersplit_eval(n,y,value,parent_objective,wt);
}
...
**  enables use to use user defined objective
**  but pre-packaged penalty
**
...
void usersplit(int n,    double *y[],     FLOAT *x,     int nclass,
	       ...
	       double myrisk,             double *wt, double penalty,
